...
if __name__ == "__main__":
    ...
    ax_1.set_title('Accuracy with varying parameters')
    ...
    fig_1.savefig(plots_directory+'accuracy.pdf')
    ...
    ax_2.set_title('Average pose error with varying parameters')
    ax_2.plot(pca_thresholds, mean_error, '-o', markersize=5)
    fig_2.savefig(plots_directory+'mean_error.pdf')